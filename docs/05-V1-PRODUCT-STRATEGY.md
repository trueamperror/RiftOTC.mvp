...
|------|-------|------------------|
| **Senior Frontend Engineer** | 1 - 2 | React/Next.js architecture, "CyberUI" implementation, Web3 state management (Wallet integration). |
...
| **Product Designer** | 1 | UI/UX high-fidelity designs (Figma), maintaining the "Cyberpunk" aesthetic key to brand identity. |
| **QA / Tester** | 3 | Automated testing (Playwright), Smart contract integration testing. |
