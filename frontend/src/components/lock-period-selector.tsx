        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
                {options.map((option) => {
                    ...
                    const riskColor = riskColors[option.riskLevel as keyof typeof riskColors] || "text-primary border-primary/30"
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-2 mb-2">
                                <Icon className={cn("w-4 h-4", isSelected ? "text-primary" : riskColor)} />
